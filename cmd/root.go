...
import (
	...
	"github.com/gkwa/helpfulferret/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.helpfulferret.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".helpfulferret")
	}
